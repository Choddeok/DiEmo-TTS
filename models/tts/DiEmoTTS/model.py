...
class ExpressiveFS2(FastSpeech):
    def __init__(self, dict_size, hparams, out_dims=None):
        ...
        self.nepoch = math.ceil((160000 * hparams["max_sentences"]) / 12155) # 12155 is the total number of training samples in the dataset
        self.momentum_schedule = cosine_scheduler(0.996, 1, self.nepoch, 12155) # Calculate how many epochs are needed to process 160,000 steps
